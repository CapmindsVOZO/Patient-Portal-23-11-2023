...
public class My_Profile_Runner extends Base_Class {
	...
	public void LoginPage() throws InterruptedException {
		...
		// Enter Email
		sendkeys(pom.getmyprof().getentermai(), "amith21@spambog.com");
		...
		// Enter Email
		Thread.sleep(2000);
		sendkeys(pom.getmyprof().getforgotmail(), "amith21@spambog.com");
		...
		// Enter Email
		Thread.sleep(2000);
		sendkeys(pom.getmyprof().getentermai1(), "amith21@spambog.com");

		// Enter pass
		Thread.sleep(3000);
		sendkeys(pom.getmyprof().getenterpass(), "Test@123");
	...
	public void Myprofile() throws InterruptedException {
		...
		selectone(pom.getmyprof().getselemailone(), "Home");
		...
		selectone(pom.getmyprof().getstat(), "Alabama");
